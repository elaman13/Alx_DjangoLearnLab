...
urlpatterns = [
    ...
    path('post/<int:pk>/comment/update/', views.CommentUpdateView.as_view(), name='comment-update-view'),
    path('post/<int:pk>/comment/delete', views.CommentDeleteView.as_view(), name='comment-delete-view')
]
